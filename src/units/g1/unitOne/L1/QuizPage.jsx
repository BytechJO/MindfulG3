        ...
        <div className="paper animate__animated animate__backInDown" id="p3">
          ...
          <div className="content">
            <div className="Q1">
              ...
              <ul>
                <li>He didn’t have enough salt for the project<input type="radio" name="q1" value="0" onChange={handleChange} /></li>
                <li>He needed it for lunch.<input type="radio" name="q1" value="1" onChange={handleChange}/></li>
                <li>He wanted to take it home.<input type="radio" name="q1" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
            ...
            <div className="Q2">
              ...
              <ul>
                <li>Rob didn’t have enough for his project.<input type="radio" name="q2" value="0" onChange={handleChange}/></li>
                <li>The teacher became angry.<input type="radio" name="q2" value="1" onChange={handleChange}/></li>
                <li>Adam made too much modelling dough.<input type="radio" name="q2" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
            ...
            <div className="Q3" >
              ...
              <ul>
                <li>To ask the cook for some salt.<input type="radio" name="q3" value="0" onChange={handleChange}/></li>
                <li>To take some salt from another classmate<input type="radio" name="q3" value="1" onChange={handleChange}/></li>
                <li>To ask the teacher for some salt.<input type="radio" name="q3" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
