      ...
      <div className="w-full max-w-6xl">
        <div className="paper animate__animated animate__backInDown" id="p3">
          ...
          <div className="content">
            ...
            <div className="Q2">
              <span>What was the look on the shopkeeper’s face
                      <br />when Ellen hurt his feelings?</span>
              <ul>
            ...
            <div className="Q3" >
              <span>What did Ellen say to the shopkeeper
                        <br />that made her father happy?</span>
              <ul>
