        ...
        <div className="paper animate__animated animate__backInDown" id="p3">
          ...
          <div className="content">
            <div className="Q1">
              ...
              <ul>
                <li>To help Peter from being bullied.<input type="radio" name="q1" value="0" onChange={handleChange} /></li>
                <li>To help her with spelling on the test.<input type="radio" name="q1" value="1" onChange={handleChange}/></li>
                <li>To help Peter with his spelling test.<input type="radio" name="q1" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
            ...
            <div className="Q2">
              ...
              <ul>
                <li>She was scared of being a telltale.<input type="radio" name="q2" value="0" onChange={handleChange}/></li>
                <li>She was scared of the spelling test.<input type="radio" name="q2" value="1" onChange={handleChange}/></li>
                <li>She was scared about not going outside.<input type="radio" name="q2" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
            ...
            <div className="Q3" >
              ...
              <ul>
                <li>Josh and Anya apologised to Peter.<input type="radio" name="q3" value="0" onChange={handleChange}/></li>
                <li>Josh and Anya continued to bully Peter.<input type="radio" name="q3" value="1" onChange={handleChange}/></li>
                <li>Josh and Anya ignored Peter.<input type="radio" name="q3" value="2" onChange={handleChange}/></li>
              </ul>
            </div>
